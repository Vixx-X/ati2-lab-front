...
export const RepresentantForm = ({ initValues }: any) => {
  ...
  return (
    <div className="pt-4">
      ...
      <div className="flex gap-x-8">
        <div className="mb-4 text-sm basis-2/4">
          <label htmlFor="representant.charge">Cargo del representante</label>
          <Field
        ...
        <div className="mb-4 text-sm basis-2/4">
          <label htmlFor="representant.phone_number">Teléfono celular</label>
          <Field
      ...
      <div className="flex gap-x-8">
        <div className="mb-4 text-sm basis-2/4">
          <label htmlFor="representant.local_phone">Teléfono Local</label>
          <Field
      ...
      <div>
        <div className="flex gap-x-8">
          ...
          <div className="mb-1 text-sm basis-1/3">
            <label htmlFor="representant.addresses[0].city">Ciudad</label>
            <Field
              label="Ciudad"
          ...
          <div className="mb-1 text-sm basis-1/3">
            <label htmlFor="representant.addresses[0].state">Estado</label>
            <Field
              label="Estado"
        ...
        <div className="flex gap-x-8">
          <div className="mb-4 text-sm basis-2/4">
            <label htmlFor="representant.addresses[0].line1">Línea 1</label>
            <Field
              label="Línea 1"
          ...
          <div className="mb-4 text-sm basis-2/4">
            <label htmlFor="representant.addresses[0].line2">Línea 2</label>
            <Field
              label="Línea 2"
